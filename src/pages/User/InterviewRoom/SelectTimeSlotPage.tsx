...
export const SelectTimeSlotPage = () => {
        ...
        try {
            ...
            if (data.status !== "PENDING") {
                if (data.status === "SELECTED") {
                    toast.info("You have already selected a time slot for this interview");
    ...
    const handleSelectSlot = async () => {
        ...
        if (Number(user.id) !== scheduleRequest.applicantId) {
            toast.error("You are not authorized to select a time slot for this interview");
            return;
        }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="font-semibold">Round {scheduleRequest.roundNumber}</p>
                            </div>
                        </div>
                    </div>
