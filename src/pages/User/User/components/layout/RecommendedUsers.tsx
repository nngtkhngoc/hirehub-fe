import { RecommendedUserCard } from "@/pages/User/Profile/components/ui/RecommendedUserCard";
import { RecommendedUserCardSkeleton } from "@/pages/User/Profile/components/ui/RecommendedUserCardSkeleton";
...
export const RecommendedUsers = () => {
  ...
  const renderUsers = () =>
    users?.content?.map((user: any) => <RecommendedUserCard user={user} />);
      ...
      <div className="flex flex-col w-full">
        ...
        {isPending ? (
          <div className="flex flex-col items-center justify-center w-full">
            {[...Array(6)].map((_, i) => (
              <RecommendedUserCardSkeleton key={i} />
            ))}
          </div>
        ) : error ? (
