...
export const JobCard = ({ job }: { job: Job }) => {
  ...
  return (
    <div className="w-[315px] h-[315px] rounded-[10px] px-5 py-5 space-y-2 bg-white hover:bg-primary cursor-pointer transition-all duration-300 group border border-[#DBDBDB] hover:shadow-[0_4px_4px_#DFD2FA] hover:scale-[1.02]">
